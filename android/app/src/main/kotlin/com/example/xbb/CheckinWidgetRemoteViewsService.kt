    ...
    override fun getViewAt(position: Int): RemoteViews? {
        ...
        return RemoteViews(context.packageName, R.layout.checkin_widget_list_item).apply {
            ...
            if (item.isChecked) {
                ...
                setViewVisibility(R.id.checkin_widget_item_btn, android.view.View.GONE)
                ...
                setViewVisibility(R.id.checkin_widget_item_btn, android.view.View.VISIBLE)
                setTextViewText(R.id.checkin_widget_item_time, "")
            }
